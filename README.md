...
```bash
python scripts/download_kitti.py --dates 2011_09_26 2011_09_28 2011_09_29 2011_09_30
...
这些图表已改为中文标题和中文坐标轴，适合直接放入报告或 PPT。
...
本地 `docs/` 目录中整理了项目报告、训练说明和答辩相关资料，包括：
