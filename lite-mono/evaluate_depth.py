...
def evaluate(opt):
        ...
        with torch.no_grad():
            for data in dataloader:
                ...
                if flops_info is None:
                    flops_info = profile_once(encoder, depth_decoder, input_color)
    ...
    if opt.ext_disp_to_eval is None and flops_info is not None:
        flops, params, flops_e, params_e, flops_d, params_d = flops_info
